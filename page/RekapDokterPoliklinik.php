...
/*				 $sql = "select sum(a.jumlah) as original,sum(a.JASA_PELAYANAN) AS J_PEL,SUM(a.operasional) AS J_RS_OPERASIONAL,
				...
				$qry	= mysql_query($sql); */
				 ...
				 $sql ="select NamaDokter, SUM(Original) AS J_PELS,
...
from t_jaspel
".$search." and KodeTindakan!='07' and KodeUnit!='15' and KodeUnit!='16' and KodeUnit!='17' and KodeUnit!='20' GROUP BY KodeDokter ORDER BY NamaDokter asc";
$qry	= mysql_query($sql);
			?>
...
from t_jaspel
".$search." and KodeTindakan!='07' and KodeUnit!='15' and KodeUnit!='16' and KodeUnit!='17' and KodeUnit!='20' ";
