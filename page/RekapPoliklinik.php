...
/*				 $sql = "select sum(a.jumlah) as original,sum(a.JASA_PELAYANAN) AS J_PEL,SUM(a.operasional) AS J_RS_OPERASIONAL,
				...
				$qry	= mysql_query($sql); */
				 ...
				 $sql ="select NamaPoly, SUM(Original) AS J_PELS,
...
from t_jaspel
".$search." and KodeTindakan!='07' and KodeUnit!='15' and KodeUnit!='16' and KodeUnit!='17' and KodeUnit!='20' GROUP BY KodeUnit ORDER BY NamaPoly asc";
$qry	= mysql_query($sql);
			?>
