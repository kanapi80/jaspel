...
<div class="table-responsive" style="padding-bottom:5px">
    ...
    <table width="100%" cellpadding="0px" cellspacing="0" class="tb" style="font-size:10px" border="0px">
            <tr>
                <td width="12%">Asuransi<br><select name="crb" class="form-cari" id="carabayar">
                        <option value="">-</option>
                     <?
...
from t_jaspel_ranap
".$search." and KodeTindakan!='07' and KodeUnit='19' and JasaPelayanan !='0.00' GROUP BY NamaPoly ORDER BY NamaPoly asc";
$qry	= mysql_query($sql);
			?>
