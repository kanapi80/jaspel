    ...
    <form name="formsearch" method="get" action="<?php $_SERVER['PHP_SELF']; ?>">
        <table width="100%" cellpadding="0px" cellspacing="0" class="tb" style="font-size:10px" border="0px">
            <tr>
                ...
                <td width="6%"> Ruang &nbsp;&nbsp;
                    <select name="poly" id="poly" class="form-cari">
                ...
                <!--  <td width="7%">Dokter
                        <select style="height:22px;font-size:12px;width:100%"  name="dokter" id="dokter" class="form-cari" >
                            <option value="0">-</option>
                            <?
                ...
                <td width="12%" valign="bottom">Urut
                    <select name="urut" class="form-cari">
                        ...
                        <option value="a.IDXDAFTAR" <? if ($urut == "a.IDXDAFTAR") echo "selected='selected'"; ?>>IDXDAFTAR</option>
                    </select>
                </td>
                <td width="0%" valign="bottom"><input type="hidden" name="link" value="<?= $_GET['link']; ?>" /></td>
                <td valign="bottom"><button type="submit" class="btn btn-outline-success btn-sm">&nbsp;<i class="fa fa-search"></i>&nbsp;Cari&nbsp;</button>
                <td>
                </td>
            </tr>
        </table>
...
$sql = "select a.*,b.NAMA,c.ket_ruang as NAMAPOLY, d.NAMADOKTER,e.nama_tindakan,e.nama_gruptindakan,DATE_FORMAT(f.keluarrs,'%Y-%m-%d')PULANG
				...
				" . $search . " and a.CARABAYAR !='8' and  a.UNIT IN ('16','17','15','20') and a.KODETARIF !='07' and a.JASA_PELAYANAN !='0.00' AND a.KODETARIF !='04.03.05' AND a.KODETARIF !='04.03.06'   ORDER BY $urut asc";
$qry    = mysql_query($sql);
?>
...
SUM(a.COSTSHARING) AS KEBERSAMAAN
				 ...
				 left join m_tarif2012 e ON e.kode_tindakan = a.KODETARIF
				 left join t_admission f ON f.id_admission = a.IDXDAFTAR
				" . $search . " and a.CARABAYAR !='8' and  a.UNIT IN ('16','17','15','20') and a.KODETARIF !='07' and a.JASA_PELAYANAN !='0.00' AND a.KODETARIF !='04.03.05' AND a.KODETARIF !='04.03.06'  ";
        ...
        <tr style="font-weight:bold;background:#36bea6;color:#FFFFFF">
            <td colspan="9" align="right" style="color:#FFFFFF">JUMLAH</td>
