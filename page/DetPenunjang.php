...
if ($poly != "") {
	$search = $search . " AND KodeUnit ='" . $poly . "' ";
}
$dokter = "";
	...
	<table width="100%" cellpadding="0px" cellspacing="0" class="tb" style="font-size:10px;" border="0px">
			...
			<td width="7%">
					Poliklinik <br /> <select  name="poly" id="poly" class="form-cari">
						...
						<?
						$qrypoly = mysql_query("SELECT * FROM m_poly where jenispoly ='1' ORDER by nama ASC ") or die(mysql_error());
...
<?php
$no;
$sql="SELECT * FROM t_jaspel
" . $search . " and KodeTindakan!='07' and KodeUnit IN('15','16','17' ,'20') and JasaPelayanan !='0.00' order by Tanggal,Nomr ";
$qry=mysql_query($sql);
?>
    ...
    <table width="100%" cellpadding="0px" cellspacing="0" id="myTable1" style="font-size:9px" border="1px">
		...
		?>
			<tr <? echo "class =";
				...
				<td align="left"><? echo $data['NamaUnit']; ?></td>
...
from t_jaspel
".$search." and KodeTindakan!='07' and  KodeUnit IN('15','16','17' ,'20') and JasaPelayanan !='0.00'  ";
