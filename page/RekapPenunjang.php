...
/*				 $sql = "select sum(a.jumlah) as original,sum(a.JASA_PELAYANAN) AS J_PEL,SUM(a.operasional) AS J_RS_OPERASIONAL,
				...
				$qry	= mysql_query($sql); */
				 ...
				 $sql ="select NamaUnit, SUM(Original) AS J_PELS,
...
from t_jaspel
".$search." and KodeTindakan!='07' and KodeUnit IN('15','16','17' ,'20') and JasaPelayanan !='0.00' GROUP BY KodeUnit ORDER BY NamaUnit asc";
$qry	= mysql_query($sql);
			?>
...
$sql2= "select  NamaPoly, SUM(Original) AS JR_PELS,
