...
SUM(a.COSTSHARING) AS KEBERSAMAAN,c.ket_ruang,d.NAMADOKTER
from t_billranap a
...
WHERE   f.JM = '" . $periode . "' and  a.CARABAYAR = '" . $crb . "'   and a.CARABAYAR !='8' and  a.UNIT ='19' and a.JASA_PELAYANAN !='0.00'  and a.KODETARIF !='07' GROUP BY d.NAMADOKTER order by d.NAMADOKTER ASC";
...
SUM(a.COSTSHARING) AS KEBERSAMAAN
				 ...
				 left join m_tarif2012 e ON e.kode_tindakan = a.KODETARIF
				 left join t_admission f ON f.id_admission = a.IDXDAFTAR
				WHERE   f.JM ='" . $periode . "' and  a.CARABAYAR = '" . $crb . "'   and a.CARABAYAR !='8' and  a.UNIT ='19' and a.JASA_PELAYANAN !='0.00' and a.KODETARIF !='07'");
