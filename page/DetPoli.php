...
<?php
$no;
$sql="SELECT a.*,b.JM FROM detail_billrajal a
left join t_pendaftaran b ON b.IDXDAFTAR =a.IDXDAFTAR
where b.JM = '$periode' and a.kode='$crb'  and a.KODETARIF!='07' and a.UNIT!='15' and a.UNIT!='16' and a.UNIT!='17' and a.UNIT!='20' order by a.TANGGAL,b.NOMR ";
$qry=mysql_query($sql);
?>
...
left join t_pendaftaran b ON b.IDXDAFTAR = a.IDXDAFTAR
where b.JM = '$periode' and a.kode='$crb'  and a.KODETARIF!='07' and a.UNIT!='15' and a.UNIT!='16' and a.UNIT!='17' and a.UNIT!='20'  ";
		$qry2	= mysql_query($sql2);
		$data2 = mysql_fetch_array($qry2); 
		?>
