            ...
            <tr>
				...
				<td width="12%" valign="bottom">Periode
					<select style="width:100%" name="periode" id="periode" class="form-cari">
                      ...
                      <td width="0%" valign="bottom"><input type="hidden" name="link" value="<?=$_GET['link'];?>" />
...
left join m_ruang c ON c.no =a.UNIT 
...
WHERE   f.JM = '".$periode."'  and  a.CARABAYAR = '" . $crb . "' and  a.UNIT IN ('15','16','17') and a.JASA_PELAYANAN !='0.00'  and a.KODETARIF !='07' AND a.KODETARIF !='04.03.05' AND a.KODETARIF !='04.03.06'  GROUP BY a.KDDOKTER"; 
...
SUM(a.COSTSHARING) AS KEBERSAMAAN
				...
				left join m_ruang c ON c.no =a.UNIT 
				 ...
				 left join m_tarif2012 e ON e.kode_tindakan = a.KODETARIF
				 join t_admission f ON f.id_admission = a.IDXDAFTAR
				WHERE   f.JM = '".$periode."'  and  a.CARABAYAR = '" . $crb . "' and  a.UNIT IN ('15','16','17') and a.JASA_PELAYANAN !='0.00'   and a.KODETARIF !='07' AND a.KODETARIF !='04.03.05' AND a.KODETARIF !='04.03.06' ");
...
$original = $hasil2['JUM'];
$jaspel = $hasil2['JS_PL'];
$ops = $hasil2['OPERASIONAL'];
$man = $hasil2['MANAJEMEN'];
$spesialis = $hasil2['MEDIS'];
$medis = $hasil2['MEDIS_UM'];
$paramedis = $hasil2['PARAMEDIS'];
$bersama = $hasil2['KEBERSAMAAN'];
?>
