...
" . $search . " and KodeTindakan!='07' and KodeUnit ='15' and JasaPelayanan !='0.00'  and KodeTindakan IN('04.03.05' ,'04.03.06')order by Tanggal,Nomr ";
$qry=mysql_query($sql);
?>
...
from t_jaspel_ranap
".$search." and KodeTindakan!='07' and KodeUnit ='15' and JasaPelayanan !='0.00'  and KodeTindakan IN('04.03.05' ,'04.03.06')  ";
