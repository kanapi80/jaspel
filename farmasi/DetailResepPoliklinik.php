...
<div class="row">
   ...
   <h5 class="card-title ">RINCIAN R/ POLIKLINIK (JM) </h5>
...
where a.JKN='".$kode."' and a.UNIT='1' and a.IBS='0' and a.RUANG='$poli' and CARABAYAR ='$_GET[crb]' order by a.ID ASC ";	 
$jalankan = mysql_query($query) or die('Error');
 ...
 $selectsx=mysql_query("SELECT SUM(QTY_R) as TOTALR,SUM(JMBAYAR) as TOTALB from r_farmasi_8 where JKN='".$kode."' and UNIT='1' and IBS='0' and RUANG='".$poli."' and CARABAYAR ='$_GET[crb]'  ");
