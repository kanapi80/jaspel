        ...
        <div align="center" style="margin:5px;">
            <form name="formsearch" method="get" >
                <table width="90%" border="0" cellspacing="0" class="tb">
                    		<?
if($_GET['unit']=="1"){
$data_kontens=mysql_query("select nama as namaruang from m_poly  where kode='$_GET[ruang]'  ");
$data=mysql_fetch_array($data_kontens);
}else if ($_GET['unit']=="2"){ 
$data_kontens=mysql_query("select ket_ruang as namaruang from m_ruang where no='$_GET[ruang]'  ");
$data=mysql_fetch_array($data_kontens);
}else{}
?>    <tr>
                          <td width="160">Nama Poliklinik / Ruangan </td>
                          <td >: <?=strtoupper($data['namaruang']);?></td>
                          </tr>
                        <tr>
                          <td>Periode</td>
                          <td>: <?=$_GET['kode']?></td>
